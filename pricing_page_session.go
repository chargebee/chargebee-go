...
type PricingPageSessionContractTermActionAtTermEnd string

const (
	PricingPageSessionContractTermActionAtTermEndRenew     PricingPageSessionContractTermActionAtTermEnd = "renew"
	PricingPageSessionContractTermActionAtTermEndEvergreen PricingPageSessionContractTermActionAtTermEnd = "evergreen"
	PricingPageSessionContractTermActionAtTermEndCancel    PricingPageSessionContractTermActionAtTermEnd = "cancel"
	PricingPageSessionContractTermActionAtTermEndRenewOnce PricingPageSessionContractTermActionAtTermEnd = "renew_once"
)
...
type PricingPageSessionCreateForNewSubscriptionRequest struct {
	...
	ContractTerm            *PricingPageSessionCreateForNewSubscriptionContractTerm    `json:"contract_term,omitempty"`
...
type PricingPageSessionCreateForNewSubscriptionContractTerm struct {
...
type PricingPageSessionCreateForExistingSubscriptionRequest struct {
	...
	ContractTerm *PricingPageSessionCreateForExistingSubscriptionContractTerm `json:"contract_term,omitempty"`
	apiRequest   `json:"-" form:"-"`
}
...
type PricingPageSessionCreateForExistingSubscriptionContractTerm struct {
	ActionAtTermEnd          ContractTermActionAtTermEnd `json:"action_at_term_end,omitempty"`
	CancellationCutoffPeriod *int32                      `json:"cancellation_cutoff_period,omitempty"`
}
