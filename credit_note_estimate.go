...
type CreditNoteEstimateLineItemProrationMode string

const (
	CreditNoteEstimateLineItemProrationModeReset                 CreditNoteEstimateLineItemProrationMode = "reset"
	CreditNoteEstimateLineItemProrationModeDelta                 CreditNoteEstimateLineItemProrationMode = "delta"
	CreditNoteEstimateLineItemProrationModeServicePeriodRevision CreditNoteEstimateLineItemProrationMode = "service_period_revision"
	CreditNoteEstimateLineItemProrationModeAdjustedTerm          CreditNoteEstimateLineItemProrationMode = "adjusted_term"
)
...
type CreditNoteEstimateLineItem struct {
	...
	CustomerId              string                                  `json:"customer_id"`
	ProrationMode           CreditNoteEstimateLineItemProrationMode `json:"proration_mode"`
	Object                  string                                  `json:"object"`
}
