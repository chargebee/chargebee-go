...
func Payment_vouchersForInvoice(id string, params *paymentvoucher.Payment_vouchersForInvoiceRequestParams) chargebee.RequestObj {
	return chargebee.SendList("GET", fmt.Sprintf("/invoices/%v/payment_vouchers", url.PathEscape(id)), params)
}
func Payment_vouchersForCustomer(id string, params *paymentvoucher.Payment_vouchersForCustomerRequestParams) chargebee.RequestObj {
