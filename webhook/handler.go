...
func (h *WebhookHandler) ParseAndDispatch(body []byte) error {
	...
	case enum.EventTypeGrantBlocksCreated:
	...
	case enum.EventTypeGrantBlocksUpdated:
	...
	case enum.EventTypeLedgerAccountBalanceUpdated:
	...
	case enum.EventTypeLedgerUpdated:
	...
	case enum.EventTypeOmnichannelSubscriptionItemMrrUpdated:
	...
	case enum.EventTypeVaultTokenCreated:
	...
	case enum.EventTypeVaultTokenDeleted:
	...
	case enum.EventTypeVaultTokenUpdated:
