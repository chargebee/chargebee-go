...
type OmnichannelSubscriptionItemScheduledChange struct {
	...
	CurrentState                  *OmnichannelSubscriptionItemScheduledChangeCurrentState   `json:"current_state"`
	ScheduledState                *OmnichannelSubscriptionItemScheduledChangeScheduledState `json:"scheduled_state"`
