...
const (
	AddressValidationStatusNotValidated   AddressValidationStatus = "not_validated"
	AddressValidationStatusValid          AddressValidationStatus = "valid"
	AddressValidationStatusPartiallyValid AddressValidationStatus = "partially_valid"
...
type Address struct {
	...
	Zip              string                  `json:"zip"`
	ValidationStatus AddressValidationStatus `json:"validation_status"`
