...
type Order struct {
	...
	ResentStatus            ResentStatus        `json:"resent_status"`
...
type UpdateRequest struct {
	...
	OrderLineItems     []*UpdateOrderLineItem `json:"order_line_items,omitempty"`
	TrackingUrl        string                 `json:"tracking_url,omitempty"`
	TrackingId         string                 `json:"tracking_id,omitempty"`
...
type UpdateOrderLineItem struct {
	Id     string                    `json:"id,omitempty"`
	Status order.OrderLineItemStatus `json:"status,omitempty"`
...
type ImportOrderRequest struct {
	...
	ShippingAddress         *ImportOrderShippingAddress `json:"shipping_address,omitempty"`
	BillingAddress          *ImportOrderBillingAddress  `json:"billing_address,omitempty"`
}
type ImportOrderShippingAddress struct {
	FirstName        string                `json:"first_name,omitempty"`
	LastName         string                `json:"last_name,omitempty"`
	Email            string                `json:"email,omitempty"`
	Company          string                `json:"company,omitempty"`
...
type ImportOrderBillingAddress struct {
	FirstName        string                `json:"first_name,omitempty"`
	LastName         string                `json:"last_name,omitempty"`
	Email            string                `json:"email,omitempty"`
	Company          string                `json:"company,omitempty"`
...
type CancelRequest struct {
	CancellationReason CancellationReason `json:"cancellation_reason"`
	CreditNote         *CancelCreditNote  `json:"credit_note,omitempty"`
	CustomerNotes      string             `json:"customer_notes,omitempty"`
	Comment            string             `json:"comment,omitempty"`
	CancelledAt        *int64             `json:"cancelled_at,omitempty"`
}
type CancelCreditNote struct {
	Total *int64 `json:"total,omitempty"`
}
type CreateRefundableCreditNoteRequest struct {
	CreditNote    *CreateRefundableCreditNoteCreditNote `json:"credit_note,omitempty"`
	CustomerNotes string                                `json:"customer_notes,omitempty"`
	Comment       string                                `json:"comment,omitempty"`
}
type CreateRefundableCreditNoteCreditNote struct {
	ReasonCode creditNote.ReasonCode `json:"reason_code"`
	Total      *int64                `json:"total"`
}
...
type OrdersForInvoiceRequest struct {
	Limit  *int32 `json:"limit,omitempty"`
	Offset string `json:"offset,omitempty"`
}
type ResendRequest struct {
	...
	OrderLineItems []*ResendOrderLineItem `json:"order_line_items,omitempty"`
}
type ResendOrderLineItem struct {
	Id                  string `json:"id,omitempty"`
...
type AssignOrderNumberResponse struct {
	Order *Order `json:"order,omitempty"`
}
...
type CreateRefundableCreditNoteResponse struct {
	Order *Order `json:"order,omitempty"`
}
...
type ListResponse struct {
	List       []*ListOrderResponse `json:"list,omitempty"`
	NextOffset string               `json:"next_offset,omitempty"`
}

type OrdersForInvoiceOrderResponse struct {
	Order *Order `json:"order,omitempty"`
}

type OrdersForInvoiceResponse struct {
	List       []*OrdersForInvoiceOrderResponse `json:"list,omitempty"`
	NextOffset string                           `json:"next_offset,omitempty"`
}
