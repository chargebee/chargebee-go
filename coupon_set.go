...
type AddCouponCodesRequest struct {
...
type AddCouponCodesResponse struct {
	CouponSet *CouponSet `json:"coupon_set,omitempty"`
}

type ListCouponSetResponse struct {
	CouponSet *CouponSet `json:"coupon_set,omitempty"`
}

type ListResponse struct {
	List       []*ListCouponSetResponse `json:"list,omitempty"`
...
type DeleteUnusedCouponCodesResponse struct {
	CouponSet *CouponSet `json:"coupon_set,omitempty"`
}
