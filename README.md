...
|----------------------------|----------|-----------------------------------------------------------------------------------------------------|---------------|
| v4                         | Active   | [v2](https://apidocs.chargebee.com/docs/api/v2?lang=go-v4) and [v1](https://apidocs.chargebee.com/docs/api/v1?lang=go-v4) | `v4`      |
| v3                         | Active   | [v2](https://apidocs.chargebee.com/docs/api/v2?lang=go-v3) and [v1](https://apidocs.chargebee.com/docs/api/v1?lang=go-v3) | `master`      |
