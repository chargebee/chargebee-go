...
type PaymentSourceCardPreferredScheme string
...
type PaymentSourceBankAccount struct {
	...
	FirstName         string            `json:"first_name"`
	LastName          string            `json:"last_name"`
	DirectDebitScheme DirectDebitScheme `json:"direct_debit_scheme"`
	BankName          string            `json:"bank_name"`
	MandateId         string            `json:"mandate_id"`
	AccountType       AccountType       `json:"account_type"`
	EcheckType        EcheckType        `json:"echeck_type"`
	AccountHolderType AccountHolderType `json:"account_holder_type"`
