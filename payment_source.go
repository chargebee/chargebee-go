...
type PaymentSourceListGatewayTokensForPaymentSourceRequest struct {
...
type PaymentSourceListGatewayTokensForPaymentSourcePaymentSourceResponse struct {
	GatewayPaymentMethodToken GatewayPaymentMethodToken `json:"gateway_payment_method_token,omitempty"`
}

type PaymentSourceListGatewayTokensForPaymentSourceResponse struct {
	List       []*PaymentSourceListGatewayTokensForPaymentSourcePaymentSourceResponse `json:"list,omitempty"`
