...
* * *
### Bug Fixes: 
- Filter operators `in`, `not_in` and `between` are now sent as a single form field on non-list requests. Filters on export operations, such as `subscription[updated_at][between]`, were index-encoded and therefore ignored by the API.
...
* * *
### New Resources:
- [`FilterCondition`](https://apidocs.chargebee.com/docs/api/filter_conditions) has been added.
- [`QuoteEntitlement`](https://apidocs.chargebee.com/docs/api/quote_entitlements) has been added.
...
- `plan_price_id` has been added as a new value to enum attribute [`field`](https://apidocs.chargebee.com/docs/api/filter_conditions/filter-condition-object#field) in [`FilterCondition`](https://apidocs.chargebee.com/docs/api/filter_conditions).
- `equals` and `not_equals` have been added as new values to enum attribute [`operator`](https://apidocs.chargebee.com/docs/api/filter_conditions/filter-condition-object#operator) in [`FilterCondition`](https://apidocs.chargebee.com/docs/api/filter_conditions).
